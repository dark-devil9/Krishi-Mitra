...
def get_answer_from_books(query: str, n_results: int = 7):
    ...
    prompt = f"""
    You are an expert agricultural assistant named Agroculture. Based on the following context, please provide a helpful and informative answer to the user's question.
